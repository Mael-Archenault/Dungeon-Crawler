...
public class Figure extends DynamicSprite{
    ...
    private final BufferedImage animationTileSheet;
    ...
    private final Rectangle2D swordRange = new Rectangle2D.Double(0, 0, swordRangeWidth, swordRangeDeepness);
    ...
    public boolean isDeathFinished(){
        double deathDelay = 2;
        return (this.dead && (this.time-this.waitStartTime)> deathDelay);
    }
